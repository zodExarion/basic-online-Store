                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                    ...
                                    <button id="order" class="dropdown-item text-center small text-white bg-danger" type="submit">
                                    ...
                                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <form action="#" method="POST"
                                                class="add_to_cart d-flex align-items-center">
                                                @csrf
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.message == 'delete'){
                            ...
                            _conf("Are you sure to DELETE this from your CART?","delete_product",[id]);
            ...
            function fetchAllCarts() {
                $.ajax({
                    ...
                    success: function (data) {
                            ...
                            <div class=" d-flex align-items-center justify-content-between ">
                                                    <div class="d-flex p-2 align-items-center w-100 ">
                                                        <div class="px-2 ">
                                                            <div class="input-group d-flex flex-nowrap ">
                                                                <div class="input-group-prepend cart-minus"
                                                                    ...
                                                                    >
                                                                    <span
                                                                        class="btn btn-sm btn-outline-secondary "><b><i
                                                                                class="fa fa-minus"></i></b></span>
                                                                </div>
                                                                <input class="qty" type="number" name="qty" id=""
                                                                    value="${cart.quantity}" readonly>
                                                                <div class="input-group-append cart-plus"
                                                                     data-id="${cart.id}"
                                                                    >
                                                                    <span
                                                                        class="btn btn-sm btn-outline-secondary "><b><i
                                                        ...
                                                        <div class="fw-bold " >
                                                            ...
                                                            <p  class="small text-gray-500 mb-0">Total:
                        ...
                        var formattedTotalSum = totalSum.toLocaleString('en-US', { style: 'currency', currency: 'PHP' });
